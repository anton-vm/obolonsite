    ...
    return (
        <div>
            ...
            <div className={"bottles wow zoomIn"}>
                        <div className={'bottle'}><img src={require('../../img/bottles/kwas_podpiwek.png')} className={style.img} data-name="kwas_podpiwek"></img></div>
                        <div className={'bottle'}><img src={require('../../img/bottles/kwas_chlebowy.png')} className={style.img} data-name="kwas_chlebowy"></img></div>
            </div>
            ...
            <div className={"bottles wow zoomIn"}>
                        <div className={'bottle'}><img src={require('../../img/bottles/kwas_sliwa.png')} className={style.img} data-name="kwas_chlebowy_sliwa"></img></div>
                        <div className={'bottle'}><img src={require('../../img/bottles/kwas_wisznia.png')} className={style.img} data-name="kwas_chlebowy_wisznia"></img></div>
            </div>
