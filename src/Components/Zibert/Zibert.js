    ...
    return (
        <div className={style.wrapperZibert}>
            <div className={`${style.productBlock} wow zoomIn`}>
                ...
                <div className={"bottle"}><img src={require('../../img/bottles/beer_zhygulivske.png')} className={style.img}/></div>
                </div>
            ...
            <div className={`${style.productBlock} wow zoomIn`}>
                ...
                <div className={"bottle"}><img src={require('../../img/bottles/beer_zibert.png')} className={style.img}/></div>
                <div className={"bottle"}><img src={require('../../img/bottles/beer_zibert_can.png')} className={style.img}/></div>
                </div>
