    ...
    return (
        <div className={style.wrapperZibert}>
            <div className={`${style.productBlock} wow zoomIn`}>
                ...
                <div className={`${style.bottlesWight} bottles`}>
                <div className={"bottle"}><img src={require('../../img/bottles/beer_zhygulivske.png')} className={style.img} data-name="zhygulivske"/></div>
                </div>
                <div className={style.textPad}>
                <div className={style.logoPad}><img src={require('../../img/elements/Zhyguli-logo.png')} className={style.logoImg}/></div>
            ...
            <div className={`${style.productBlock} ${style.productBlockZibert} wow zoomIn`}>
                <div className={style.logo}><img src={require('../../img/elements/zibert-logo.png')} className={style.logoImg}/></div>
                <div className={`${style.bottlesWight} bottles ${style.can}`}>
                ...
                <div className={style.textPad}>
                <div className={style.logoPad}><img src={require('../../img/elements/zibert-logo.png')} className={style.logoImg}/></div>
